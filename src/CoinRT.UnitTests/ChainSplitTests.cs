...
namespace CoinRT.UnitTests
{
    ...
    public class ChainSplitTests
    {
        ...
        public void SetUp()
        {
            ...
            _someOtherGuy = EcKey.Create().ToAddress(_unitTestParams);
        }
        ...
        public void TestForking3()
        {
            ...
            _chain.Add(b1);
            Assert.AreEqual("50.00", Utils.BitcoinValueToFriendlystring(_wallet.GetBalance()));
            var dest = EcKey.Create().ToAddress(_unitTestParams);
        ...
        public void TestDoubleSpendOnFork()
        {
            ...
            var yetAnotherGuy = EcKey.Create().ToAddress(_unitTestParams);
            ...
            var b2 = b1.CreateNextBlock(EcKey.Create().ToAddress(_unitTestParams));
            b2.AddTransaction(t1);
            b2.Solve();
            _chain.Add(b2);

            // Now we make a double spend become active after a re-org.
            var b3 = b1.CreateNextBlock(EcKey.Create().ToAddress(_unitTestParams));
            b3.AddTransaction(t2);
            b3.Solve();
            _chain.Add(b3); // Side chain.
            var b4 = b3.CreateNextBlock(EcKey.Create().ToAddress(_unitTestParams));
        ...
        public void TestDoubleSpendOnForkPending()
        {
            ...
            var b5 = b2.CreateNextBlock(EcKey.Create().ToAddress(_unitTestParams));
            _chain.Add(b5);
            var b6 = b5.CreateNextBlock(EcKey.Create().ToAddress(_unitTestParams));
            _chain.Add(b6);
