...
namespace CoinRT.UnitTests
{
    ...
    public class WalletTest
    {
        ...
        public void Balance()
        {
            ...
            var spend = _wallet.CreateSend(EcKey.Create().ToAddress(_params), v3);
        ...
        public void BlockChainCatchup()
        {
            ...
            var send1 = _wallet.CreateSend(EcKey.Create().ToAddress(_params), Utils.ToNanoCoins(0, 10), _myAddress);
            ...
            var send2 = _wallet.CreateSend(EcKey.Create().ToAddress(_params), Utils.ToNanoCoins(0, 10), _myAddress);
        ...
        public void Transactions()
        {
            ...
            var someOtherGuy = EcKey.Create().ToAddress(_params);
        ...
        public void FinneyAttack()
        {
            ...
            var send1 = _wallet.CreateSend(EcKey.Create().ToAddress(_params), Utils.ToNanoCoins(0, 50));
            // Create a double spend.
            var send2 = _wallet.CreateSend(EcKey.Create().ToAddress(_params), Utils.ToNanoCoins(0, 50));
            // Broadcast send1.
